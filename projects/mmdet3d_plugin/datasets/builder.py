...
from projects.mmdet3d_plugin.datasets.samplers.group_sampler import (InfiniteGroupEachSampleInBatchSampler, InfiniteGroupEachSampleInBatchSamplerForVGGT)
...
def build_dataloader(dataset,
    ...
    if runner_type['type'] == 'IterBasedRunner' and shuffler_sampler['type'] =='InfiniteGroupEachSampleInBatchSamplerForVGGT':
        # TODO: original has more options, but I'm not using them 
        # https://github.com/open-mmlab/mmdetection/blob/3b72b12fe9b14de906d1363982b9fba05e7d47c1/mmdet/datasets/builder.py#L145-L157
        batch_sampler = InfiniteGroupEachSampleInBatchSamplerForVGGT(
            dataset,
            samples_per_gpu,
            world_size,
            rank,
